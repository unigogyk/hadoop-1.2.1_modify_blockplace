...
/*panfengfeng modify*/
    ...
    if( numTargets == datanode.dfsreplication - 1 ) {
    	System.out.println("panfengfeng:  numTargets == replication_num -1, that means this node is the first node of pipeline " + localAddress);
	isFirstdn = true;
    }
/*panfengfeng end*/
    ...
    */
      blockReceiver = new BlockReceiver(block, in, 
          s.getRemoteSocketAddress().toString(),
          s.getLocalSocketAddress().toString(),
          isRecovery, isFirstdn, client, srcDataNode, datanode);
    /*panfengfeng end*/
      //
