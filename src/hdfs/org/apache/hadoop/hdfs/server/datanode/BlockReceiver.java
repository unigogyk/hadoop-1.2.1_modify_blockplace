...
class BlockReceiver implements java.io.Closeable, FSConstants {
  ...
  /*panfengfeng modify*/
  private boolean isFirstdn = false;
  /*panfengfeng end*/
...
/*panfengfeng modify*/
  BlockReceiver(Block block, DataInputStream in, String inAddr,
                String myAddr, boolean isRecovery, boolean isFirstdn, String clientName, 
...
/*panfengfeng end*/
    try{
      ...
      */
      streams = datanode.data.writeToBlock(block, isRecovery, isFirstdn, 
                              clientName == null || clientName.length() == 0);
